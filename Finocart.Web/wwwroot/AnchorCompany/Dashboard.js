   ...
   // debugger
    $('#tbl_DiscountAnchorCompList').dataTable({
        ...
        "columns": [       
            ...
            { "data": "companyID", "name": "companyID", "autoWidth": true, "visible": false }, //index 2   
            { "data": "totalInvoice", "name": "TotalInvoice", "autoWidth": true, "class": "clsamountPaid" },
            { "data": "totalInvoiceAmount", "name": "TotalInvoiceAmount", "autoWidth": true, "class": "clsearning", render: $.fn.dataTable.render.number(',', '.', 0) }
            ],
        });
